...
- [[esAutomationLinuxGit|Auto push using git (Linux)]]
- [[esAutomationWindows|Auto push using git (Windows)]]
...
- [[esAutomationLinuxSSH|Auto push to local webserver (Linux)]]
- [[esAutomationWindowsSSH|Auto push to local webserver (Windows)]]
