...
> Note: we've compiled our site twice, once to [https://obsidian-html.github.io/](https://obsidian-html.github.io/)index_from_tags/ in that case, that url is the **host_root**.   
...
- Same as [Match key](#match-key), but will exclude notes   
...
- At the moment only the [first-paragraphs](#first-paragraphs) function is implemented for this setting.   
