...
- [Auto push site using Git on Linux](../Automation/AutomationLinuxGit.md)
- [Auto push site using SSH on Linux](../Automation/AutomationLinuxSSH.md)
- [Auto push site using Git on Windows](../Automation/AutomationWindows.md)
- [Auto push site using Git on Windows](../Automation/AutomationWindowsSSH.md)

## feature/parsing_markdown

- [Tags Page](../Configurations/Features/Tags%20Page.md)
- [Basics](../Demonstrations/Getting%20the%20basics%20right.md)
