...
//fetch('/index_from_tags/obs.html/data/search.json').then(res => res.json()).then(data => {

GzipUnzipLocalFile('/index_from_tags/obs.html/data/search.json.gzip').then(data => {
